...
import { ColDef, ColGroupDef, ColumnApi, GetLocaleTextParams, Grid, GridApi, GridOptions, GridReadyEvent, ICellRendererComp, ICellRendererParams, SideBarDef, StatusPanelDef } from '@ag-grid-community/core';
...
public getLocaleText: (params: GetLocaleTextParams) => string = function (params: GetLocaleTextParams) {
    switch (params.key) {
