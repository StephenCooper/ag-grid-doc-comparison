...
onCellValueChanged = (event) => {
   ...
   onBtStartEditing = () => {
    ...
    <div style={{"marginBottom":"5px"}}>
        <button style={{"fontSize":"12px"}} onClick={() => this.onBtStartEditing()}>Start Editing Line 2</button>
        <button style={{"fontSize":"12px"}} onClick={() => this.onBtStopEditing()}>Stop Editing</button>
    </div>
    <div
