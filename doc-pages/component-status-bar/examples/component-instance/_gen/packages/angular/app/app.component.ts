...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, StatusPanelDef } from 'ag-grid-community';
import { ClickableStatusBarComponent } from './clickable-status-bar-component.component';

@Component({
    selector: 'my-app',
    template: `<button (click)="toggleStatusBarComp()" style="margin-bottom: 10px">Toggle Status Bar Component</button>
<ag-grid-angular
