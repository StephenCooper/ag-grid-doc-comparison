...
import { ColDef, ColGroupDef, GetDataPath, GetRowIdFunc, Grid, GridOptions, ICellRendererComp, ICellRendererParams, RowNode } from '@ag-grid-community/core';
...
// Attach external event handlers to window so they can be called from index.html
 ...
 (<any>window).moveSelectedNodeToTarget = moveSelectedNodeToTarget;
}