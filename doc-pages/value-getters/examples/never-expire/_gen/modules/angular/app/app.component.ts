...
import { ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, Grid, GridApi, GridOptions, GridReadyEvent, ValueFormatterParams, ValueGetterParams } from '@ag-grid-community/core';
...
<div style="position: absolute; top: 10px; left: 15px;">
    ...
    <button (click)="onRefreshCells()">Aggregate Data &amp; Refresh Cells</button>
</div>`
})
