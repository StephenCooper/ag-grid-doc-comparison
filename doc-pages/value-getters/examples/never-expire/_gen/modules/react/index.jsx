...
<div style={{"height":"100%","boxSizing":"border-box","paddingTop":"20px"}}>
    <div
...
<div style={{"position":"absolute","top":"10px","left":"15px"}}>
    <button onClick={() => this.onUpdateOneValue()}>Update One Value</button>
    <button onClick={() => this.onExpireValueCache()}>Expire Value Cache</button>
    <button onClick={() => this.onRefreshCells()}>Aggregate Data &amp; Refresh Cells</button>
</div>
            </div>
        );
    }
