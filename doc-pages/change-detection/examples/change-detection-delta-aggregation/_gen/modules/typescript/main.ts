...
import { ColDef, ColGroupDef, GetRowIdFunc, Grid, GridApi, GridOptions, IAggFunc, RowNode, ValueParserParams } from '@ag-grid-community/core';
...
// Attach external event handlers to window so they can be called from index.html
 ...
 (<any>window).removeUsingTransaction = removeUsingTransaction;
 (<any>window).addUsingTransaction = addUsingTransaction;
 (<any>window).changeGroupUsingTransaction = changeGroupUsingTransaction;
}