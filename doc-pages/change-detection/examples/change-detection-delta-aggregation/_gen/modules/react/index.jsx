      ...
      <div style={{ width: "100%", height: "100%" }}>
        <div className="parent-container">
          <div className="top-container">
            ...
            <button onClick={() => this.updateUsingTransaction()}>
              Update Using Transaction
            </button>
            <button onClick={() => this.removeUsingTransaction()}>
              Remove Using Transaction
            </button>
            <button onClick={() => this.addUsingTransaction()}>
              Add Using Transaction
            </button>
            <button onClick={() => this.changeGroupUsingTransaction()}>
