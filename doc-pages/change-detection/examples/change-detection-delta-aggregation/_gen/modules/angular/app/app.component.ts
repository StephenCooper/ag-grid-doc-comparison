...
import { ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, Grid, GridApi, GridOptions, GridReadyEvent, IAggFunc, RowNode, ValueParserParams } from '@ag-grid-community/core';
...
@Component({
    ...
    <div class="top-container">
        ...
        <button (click)="updateUsingTransaction()">Update Using Transaction</button>
        <button (click)="removeUsingTransaction()">Remove Using Transaction</button>
        <button (click)="addUsingTransaction()">Add Using Transaction</button>
        <button (click)="changeGroupUsingTransaction()">Change Group Using Transaction</button>
    </div>
