...
const VueExample = {
    ...
    data: function() {
        return {
            columnDefs: [{headerName:"Student ID",
field:"student"},{headerName:"Year Group",
field:"yearGroup",
rowGroup:true},{headerName:"Age",
field:"age"},{headerName:"Course",
field:"course",
pivot:true},{headerName:"Age Range",
valueGetter:ageRangeValueGetter,
pivot:true},{headerName:"Points",
field:"points",
aggFunc:"sum"}],
            gridApi: null,
            columnApi: null,
...
window.pickExistingRowNodeAtRandom = function pickExistingRowNodeAtRandom(gridApi) {
    var allItems = [];
...
window.pickExistingRowItemAtRandom = function pickExistingRowItemAtRandom(gridApi) {
