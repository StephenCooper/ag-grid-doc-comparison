...
addFiveItems = (append) => {
   ...
   reverseItems = () => {
    ...
    <div style={{"marginBottom":"5px","minHeight":"30px"}}>
        ...
        <button id="groupingOn" onClick={() => this.onGroupingEnabled(true)}>Grouping On</button>
        <button id="groupingOff" onClick={() => this.onGroupingEnabled(false)}>Grouping Off</button>
        <span style={{"border":"1px solid lightgrey","marginLeft":"20px","padding":"8px","whiteSpace":"nowrap","display":"inline-block"}}>
            Group:
