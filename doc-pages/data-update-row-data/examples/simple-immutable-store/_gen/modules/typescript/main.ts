...
import { ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, Grid, GridOptions, StatusPanelDef } from '@ag-grid-community/core';
...
// Attach external event handlers to window so they can be called from index.html
 ...
 (<any>window).setSelectedToGroup = setSelectedToGroup;
 (<any>window).updatePrices = updatePrices;
 (<any>window).onGroupingEnabled = onGroupingEnabled;
 (<any>window).reverseItems = reverseItems;
}