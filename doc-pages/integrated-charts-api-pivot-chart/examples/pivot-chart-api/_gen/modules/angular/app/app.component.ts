...
import { ColDef, ColGroupDef, ColumnApi, CreatePivotChartParams, FirstDataRenderedEvent, Grid, GridApi, GridOptions, GridReadyEvent } from '@ag-grid-community/core';
...
onGridReady(params: GridReadyEvent) {
        ...
        this.http.get<any[]>('https://www.ag-grid.com/example-assets/wide-spread-of-sports.json').subscribe(data => {
    this.rowData = data;
});
    }
}
