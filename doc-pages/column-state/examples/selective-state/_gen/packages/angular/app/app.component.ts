...
@Component({
    ...
    <div class="test-header">
        <div class="example-section">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button (click)="onBtSaveOrderAndVisibilityState()">Save Order &amp; Visibility</button>
            <button (click)="onBtRestoreOrderAndVisibilityState()">Restore Order &amp; Visibility</button>
        </div>
    </div>
    <ag-grid-angular
