        ...
        <div className="test-container">
          <div className="test-header">
            <div className="example-section">
              <button onClick={() => this.onBtSaveSortState()}>
                Save Sort
              </button>
              <button onClick={() => this.onBtRestoreSortState()}>
                Restore Sort
              </button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <button onClick={() => this.onBtSaveOrderAndVisibilityState()}>
                Save Order &amp; Visibility
              </button>
              <button onClick={() => this.onBtRestoreOrderAndVisibilityState()}>
