        ...
        <table>
            <tbody><tr>
                ...
                <td>
                    ...
                    <button (click)="onBtSortCountryThenSportClearOthers()">Sort Country, then Sport - Clear
                        Others</button>
            ...
            <tr>
                ...
                <td>
                    <button (click)="onBtOrderColsMedalsFirst()">Show Medals First</button>
                    <button (click)="onBtOrderColsMedalsLast()">Show Medals Last</button>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <button (click)="onBtRowGroupCountryThenSport()">Group Country then Sport</button>
                    <button (click)="onBtRemoveCountryRowGroup()">Remove Country</button>
                    <button (click)="onBtClearAllRowGroups()">Clear All Groups</button>
                </td>
            </tr>
        </tbody></table>
    </div>
