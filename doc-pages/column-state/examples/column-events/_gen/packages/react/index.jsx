   ...
   onBtPinnedOff = () => {
    ...
    <div className="test-header">
        <div className="test-button-row">
            ...
            <div className="test-button-group">
                <button onClick={() => this.onBtWidthNarrow()}>Width Narrow</button>
                <br />
                <button onClick={() => this.onBtWidthNormal()}>Width Normal</button>
            </div>
            <div className="test-button-group">
            ...
            <div className="test-button-group">
                <button onClick={() => this.onBtReverseOrder()}>Reverse Medal Order</button>
                <br />
                <button onClick={() => this.onBtNormalOrder()}>Normal Medal Order</button>
            </div>
            <div className="test-button-group">
                <button onClick={() => this.onBtRowGroupOn()}>Row Group On</button>
                <br />
                <button onClick={() => this.onBtRowGroupOff()}>Row Group Off</button>
            </div>
            <div className="test-button-group">
                <button onClick={() => this.onBtAggFuncOn()}>Agg Func On</button>
                <br />
                <button onClick={() => this.onBtAggFuncOff()}>Agg Func Off</button>
            </div>
            <div className="test-button-group">
