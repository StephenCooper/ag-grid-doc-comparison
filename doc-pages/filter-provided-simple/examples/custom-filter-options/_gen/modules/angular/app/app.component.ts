...
import { ColDef, ColGroupDef, ColumnApi, GetLocaleTextParams, Grid, GridApi, GridOptions, GridReadyEvent, IFilterOptionDef } from '@ag-grid-community/core';
...
public getLocaleText: (params: GetLocaleTextParams) => string = (params: GetLocaleTextParams) => {
