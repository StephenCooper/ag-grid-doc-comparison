...
import { ColDef, ColGroupDef, ColumnApi, FilterChangedEvent, FilterModifiedEvent, FilterOpenedEvent, Grid, GridApi, GridOptions, GridReadyEvent, IProvidedFilter } from '@ag-grid-community/core';
...
onFilterModified(e: FilterModifiedEvent) {
    ...
    console.log('filterInstance.getModelFromUi() =>', (e.filterInstance as unknown as IProvidedFilter).getModelFromUi());
}
