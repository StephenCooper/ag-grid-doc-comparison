...
const updateRowData = useCallback((rowCount) => {
   ...
   const cbFloatingRows = useCallback(() => {
    ...
    if (show) {
        ...
        gridRef.current.api.setPinnedBottomRowData([createRow(997), createRow(996)]);
    }
    else {
   ...
   const setFixedHeight = useCallback(() => {
    ...
    return  (
            <div >
                <div className="test-header" style={{"padding":"5px","justifyContent":"space-between"}}>
    ...
    <div style={{"alignItems":"center"}}>
        <label>
            <input type="checkbox" id="floating-rows" onClick={cbFloatingRows} style={{"verticalAlign":"text-top"}} />
            <span style={{"backgroundColor":"#00e5ff","width":"15px","height":"15px","border":"1px solid #888","display":"inline-block","verticalAlign":"text-top"}}></span>
            Pinned Rows
        </label>
...
<div style={{"border":"10px solid #eee","padding":"10px","marginTop":"20px"}}>
