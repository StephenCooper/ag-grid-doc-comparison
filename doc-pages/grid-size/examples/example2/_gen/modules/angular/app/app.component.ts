...
import { ColDef, ColGroupDef, ColumnApi, FirstDataRenderedEvent, Grid, GridApi, GridOptions, GridReadyEvent, GridSizeChangedEvent, RowHeightParams } from '@ag-grid-community/core';
...
public getRowHeight: (params: RowHeightParams) => number | undefined | null = function () {
