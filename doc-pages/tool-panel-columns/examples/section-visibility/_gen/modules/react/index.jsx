   ...
   showPivotSection = () => {
    ...
    <div>
        <span className="button-group">
            <button onClick={() => this.showPivotModeSection()}>Show Pivot Mode Section</button>
            <button onClick={() => this.showRowGroupsSection()}>Show Row Groups Section</button>
            <button onClick={() => this.showValuesSection()}>Show Values Section</button>
            <button onClick={() => this.showPivotSection()}>Show Pivot Section</button>
        </span>
