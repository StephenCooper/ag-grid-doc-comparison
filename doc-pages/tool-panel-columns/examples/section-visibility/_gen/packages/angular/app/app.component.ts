...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, IColumnToolPanel, SideBarDef } from 'ag-grid-community';
...
@Component({
    ...
    <div>
        <span class="button-group">
            <button (click)="showPivotModeSection()">Show Pivot Mode Section</button>
            <button (click)="showRowGroupsSection()">Show Row Groups Section</button>
