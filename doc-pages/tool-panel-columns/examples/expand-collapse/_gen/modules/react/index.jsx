   ...
   collapseCompetitionGroups = () => {
    ...
    <div>
        <span className="button-group">
            ...
            <button onClick={() => this.collapseAllGroups()}>Collapse All</button>
            <button onClick={() => this.expandAthleteAndCompetitionGroups()}>Expand Athlete &amp; Competition</button>
            <button onClick={() => this.collapseCompetitionGroups()}>Collapse Competition</button>
        </span>
    </div>
    <div
