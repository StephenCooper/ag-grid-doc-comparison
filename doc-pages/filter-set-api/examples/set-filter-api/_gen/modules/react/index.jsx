...
selectJohnAndKenny = () => {
   ...
   setCountriesToAll = () => {
    ...
    <div className="example-header">
        <div>
            Athlete:
            <button onClick={() => this.selectNothing()}>API: Filter empty set</button>
            <button onClick={() => this.selectJohnAndKenny()}>API: Filter only John Joe Nevin and Kenny Egan</button>
            <button onClick={() => this.selectEverything()}>API: Remove filter</button>
        </div>
        <div style={{"paddingTop":"10px"}}>
            Country - available filter values
            <button onClick={() => this.setCountriesToFranceAustralia()}>Filter values restricted to France and Australia</button>
            <button onClick={() => this.setCountriesToAll()}>Make all countries available</button>
        </div>
    </div>
    <div
