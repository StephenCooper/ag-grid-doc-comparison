...
sortByAthleteAsc = () => {
   ...
   restoreFromSave = () => {
    ...
    <div style={{"marginBottom":"1rem"}}>
        <div>
            <button onClick={() => this.sortByAthleteAsc()}>Athlete Ascending</button>
            <button onClick={() => this.sortByAthleteDesc()}>Athlete Descending</button>
            <button onClick={() => this.sortByCountryThenSport()}>Country, then Sport</button>
            <button onClick={() => this.sortBySportThenCountry()}>Sport, then Country</button>
        </div>
        <div style={{"marginTop":"0.25rem"}}>
            <button onClick={() => this.clearSort()}>Clear Sort</button>
            <button onClick={() => this.saveSort()}>Save Sort</button>
            <button onClick={() => this.restoreFromSave()}>Restore from Save</button>
        </div>
    </div>
    <div
