...
import { ColDef, ColGroupDef, Grid, GridOptions, IServerSideDatasource, IServerSideGetRowsParams, ServerSideStoreType, SetFilterValuesFuncParams } from '@ag-grid-community/core';
...
// Attach external event handlers to window so they can be called from index.html
 (<any>window).onBtApply = onBtApply;
}