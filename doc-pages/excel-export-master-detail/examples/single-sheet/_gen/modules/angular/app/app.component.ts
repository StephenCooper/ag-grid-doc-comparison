...
import { ColDef, ColGroupDef, ColumnApi, CsvCell, CsvExportParams, ExcelCell, ExcelExportParams, ExcelStyle, GetDetailRowDataParams, Grid, GridApi, GridOptions, GridReadyEvent, IDetailCellRendererParams, ProcessRowGroupForExportParams } from '@ag-grid-community/core';
...
var getCells = (params: ProcessRowGroupForExportParams) => {
    ...
    ].concat(params.node.data.callRecords.map(function (record: any) {
        return [
            cell(''),
