...
export default class extends Component {
  ...
  binDrop = (event) => {
    ...
    const rowIsInLeftGrid = !!this.state.leftGridOptions.api.getRowNode(
      data.id
    );
    if (rowIsInLeftGrid) {
    ...
    const rowIsInRightGrid = !!this.state.rightGridOptions.api.getRowNode(
      data.id
    );
    if (rowIsInRightGrid) {
  ...
  gridDrop = (grid, event) => {
    ...
    const gridApi =
      grid === "left"
        ? this.state.leftGridOptions.api
        : this.state.rightGridOptions.api;
  ...
  render() {
    return (
      <div className="outer">
        ...
        >
          <AgGridReact
            gridOptions={this.state.leftGridOptions}
        ...
        <div className="inner-col factory-panel">
          ...
          <span
            draggable="true"
            onDragStart={this.dragStart.bind(this, "Red")}
          ...
          <span
            draggable="true"
            onDragStart={this.dragStart.bind(this, "Green")}
          ...
          <span
            draggable="true"
            onDragStart={this.dragStart.bind(this, "Blue")}
