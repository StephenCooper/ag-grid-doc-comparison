...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, RowClassParams, RowStyle } from 'ag-grid-community';
...
@Component({
    ...
    <div class="example-header">
        ...
        <select (change)="onPinnedRowTopCount()" id="top-row-count" style="margin-left: 10px; margin-right: 20px;">
        ...
        <select (change)="onPinnedRowBottomCount()" id="bottom-row-count" style="margin-left: 10px;">
            <option value="0">0</option>
            <option value="1" selected="">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
...
public getRowStyle: (params: RowClassParams) => RowStyle | undefined = function (params) {
    if (params.node.rowPinned) {
