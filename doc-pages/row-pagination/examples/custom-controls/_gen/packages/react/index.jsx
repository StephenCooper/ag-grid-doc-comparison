   ...
   onBtPageFifty = () => {
    ...
    <div className="example-header">
        <div>
            ...
            <button onClick={() => this.onBtLast()} id="btLast">To Last</button>
        ...
        <div style={{"marginTop":"6px"}}>
            ...
            <span className="value" id="lbLastPageFound">-</span>
            <span className="label">Page Size:</span>
            <span className="value" id="lbPageSize">-</span>
            <span className="label">Total Pages:</span>
            <span className="value" id="lbTotalPages">-</span>
            <span className="label">Current Page:</span>
            <span className="value" id="lbCurrentPage">-</span>
        </div>
    </div>
    <div
