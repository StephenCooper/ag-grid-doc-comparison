...
onUpdateSomeValues = () => {
   ...
   onFlashTwoRows = () => {
    ...
    <div style={{"marginBottom":"4px"}}>
        <button onClick={() => this.onUpdateSomeValues()}>Update Some Data</button>
        <button onClick={() => this.onFlashOneCell()} style={{"marginLeft":"15px"}}>Flash One Cell</button>
        <button onClick={() => this.onFlashTwoRows()}>Flash Two Rows</button>
        <button onClick={() => this.onFlashTwoColumns()}>Flash Two Columns</button>
    </div>
