...
@Component({
    ...
    <div class="test-header">
        <div style="margin-bottom: 10px">
            ...
            <button (click)="filterUKAndIrelandBoxing()">UK and Ireland Boxing</button>
            <button (click)="filterUKAndIrelandEquestrian()">UK and Ireland Equestrian</button>
            <button (click)="filterUsaAndCanadaBoxing()">USA and Canada Bobsleigh</button>
            <button (click)="filterUsaAndCanadaEquestrian()">USA and Canada Equestrian</button>
        </div>
