      ...
      <div className="test-container">
        <div className="test-header">
          <div style={{ marginBottom: "10px" }}>
            ...
            <button onClick={filterUKAndIrelandBoxing}>
              UK and Ireland Boxing
            </button>
            <button onClick={filterUKAndIrelandEquestrian}>
              UK and Ireland Equestrian
            </button>
            <button onClick={filterUsaAndCanadaBoxing}>
              USA and Canada Bobsleigh
            </button>
            <button onClick={filterUsaAndCanadaEquestrian}>
