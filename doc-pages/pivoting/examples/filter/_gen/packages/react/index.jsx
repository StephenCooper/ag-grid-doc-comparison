   ...
   filterUsaAndCanadaEquestrian = () => {
    ...
    <div className="test-header">
        <div style={{"marginBottom":"10px"}}>
            ...
            <button onClick={() => this.filterUKAndIrelandBoxing()}>UK and Ireland Boxing</button>
            <button onClick={() => this.filterUKAndIrelandEquestrian()}>UK and Ireland Equestrian</button>
            <button onClick={() => this.filterUsaAndCanadaBoxing()}>USA and Canada Bobsleigh</button>
            <button onClick={() => this.filterUsaAndCanadaEquestrian()}>USA and Canada Equestrian</button>
        </div>
