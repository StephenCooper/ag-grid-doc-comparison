...
turnOffPivotMode = () => {
   ...
   exportToCsv = () => {
    ...
    <div>
        <button onClick={() => this.turnOnPivotMode()}>Pivot Mode On</button>
        <button onClick={() => this.turnOffPivotMode()}>Pivot Mode Off</button>
        <button onClick={() => this.addPivotColumn()} style={{"marginLeft":"15px"}}>Pivot Country</button>
        <button onClick={() => this.addPivotColumns()}>Pivot Year &amp; Country</button>
        <button onClick={() => this.removePivotColumn()}>Un-Pivot Country</button>
    </div>
    <div style={{"marginTop":"5px"}}>
        <button onClick={() => this.emptyPivotColumns()}>Remove All Pivots</button>
        <button onClick={() => this.exportToCsv()} style={{"marginLeft":"15px"}}>CSV Export</button>
    </div>
</div>
