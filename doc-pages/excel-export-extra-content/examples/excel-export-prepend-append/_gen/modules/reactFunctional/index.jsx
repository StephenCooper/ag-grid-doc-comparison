...
const onBtExport = useCallback(() => {
    ...
    <div className="columns">
        <label className="option" for="prependContent"><input type="checkbox" id="prependContent" />Prepend Content</label>
        <label className="option" for="appendContent"><input type="checkbox" id="appendContent" /> Append Content</label>
    </div>
    <div>
        <button onClick={onBtExport} style={{"margin":"5px 0px","fontWeight":"bold"}}>Export to Excel</button>
    </div>
