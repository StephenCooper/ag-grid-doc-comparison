...
import { ColDef, ColGroupDef, ColumnApi, ExcelStyle, Grid, GridApi, GridOptions, GridReadyEvent } from '@ag-grid-community/core';
...
@Component({
    ...
    <div class="columns">
        <div>
            <button (click)="onBtExport()" style="font-weight: bold; margin-bottom: 5px;">Export to Excel</button>
        </div>
    </div>
