...
const VueExample = {
    ...
    data: function() {
        return {
            columnDefs: [{field:"dateModified",
cellClassRules:cellClassRules},{field:"size",
...
window.isSelectionParentOfTarget = function isSelectionParentOfTarget(selectedNode, targetNode) {
...
window.setPotentialParentForNode = function setPotentialParentForNode(api, overNode) {
