...
ModuleRegistry.registerModules([ClientSideRowModelModule, RangeSelectionModule, ClipboardModule])
   ...
   redo = () => {
    ...
    <div>
        <span className="button-group">
            ...
            <button id="undoBtn" className="undo-btn" onClick={() => this.undo()}>Undo</button>
            <button id="redoBtn" className="redo-btn" onClick={() => this.redo()}>Redo</button>
        </span>
    </div>
    <div
