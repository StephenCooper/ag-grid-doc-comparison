...
const getRowData = useCallback(() => {
   ...
   const onAddRow = useCallback((category) => {
   ...
   const onRemoveSelected = useCallback(() => {
    ...
    <div style={{"marginBottom":"5px"}}>
        <div>
            <button className="bt-action" onClick={() => onAddRow('For Sale')}>Add For Sale</button>
            <button className="bt-action" onClick={() => onAddRow('In Workshop')}>Add In Workshop</button>
            <button className="bt-action" onClick={onRemoveSelected}>Remove Selected</button>
            <button className="bt-action" onClick={getRowData}>Get Row Data</button>
        </div>
        <div style={{"marginTop":"5px"}}>
            <button className="bt-action" onClick={() => onMoveToGroup('For Sale')}>Move to For Sale</button>
            <button className="bt-action" onClick={() => onMoveToGroup('In Workshop')}>Move to In Workshop</button>
            <button className="bt-action" onClick={() => onMoveToGroup('Sold')}>Move to Sold</button>
        </div>
    </div>
