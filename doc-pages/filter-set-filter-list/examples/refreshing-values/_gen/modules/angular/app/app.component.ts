...
import { ColDef, ColGroupDef, ColumnApi, FirstDataRenderedEvent, Grid, GridApi, GridOptions, GridReadyEvent, IFiltersToolPanel, ISetFilter, ISetFilterParams, SetFilterValuesFuncParams, SideBarDef } from '@ag-grid-community/core';
...
@Component({
    ...
    <div id="header">
        <button (click)="useList1()">Use <code>['Elephant', 'Lion', 'Monkey']</code></button>
        <button (click)="useList2()">Use <code>['Elephant', 'Giraffe', 'Tiger']</code></button>
    </div>
    <ag-grid-angular
