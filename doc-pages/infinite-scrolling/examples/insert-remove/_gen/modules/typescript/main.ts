...
import { ColDef, ColGroupDef, GetRowIdFunc, Grid, GridOptions, ICellRendererParams, IDatasource, IGetRowsParams, RowClassParams, RowStyle, ValueFormatterParams } from '@ag-grid-community/core';
...
// Attach external event handlers to window so they can be called from index.html
 ...
 (<any>window).printCacheState = printCacheState;
