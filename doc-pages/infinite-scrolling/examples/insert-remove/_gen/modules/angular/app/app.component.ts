...
import { ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, Grid, GridApi, GridOptions, GridReadyEvent, ICellRendererParams, IDatasource, IGetRowsParams, RowClassParams, RowStyle, ValueFormatterParams } from '@ag-grid-community/core';
...
public getRowStyle: (params: RowClassParams) => RowStyle | undefined = function (params: RowClassParams) {
