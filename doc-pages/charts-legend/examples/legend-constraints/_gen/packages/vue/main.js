        ...
        <div class="wrapper">
                <div class="toolPanel">
                    <div class="slider">
                        ...
                        <input type="range" id="xPaddingLabel" min="0" max="50" value="32" v-on:input="updateLegendItemPaddingX($event)" v-on:change="updateLegendItemPaddingX($event)">
                    </div>
                </div>
                <div class="toolPanel">
                    <div class="slider">
                        ...
                        <input type="range" id="yPaddingLabel" min="0" max="30" value="8" v-on:input="updateLegendItemPaddingY($event)" v-on:change="updateLegendItemPaddingY($event)">
                    </div>
                </div>
                <div class="toolPanel">
                    <div class="slider">
                        ...
                        <input type="range" id="markerPaddingLabel" min="0" max="30" value="8" v-on:input="updateLegendItemSpacing($event)" v-on:change="updateLegendItemSpacing($event)">
                    </div>
                </div>
                <ag-charts-vue    
