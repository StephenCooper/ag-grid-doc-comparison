...
this.setState({ options });
    ...
    <div className="toolPanel">
        <div className="slider">
            ...
            <span id="xPaddingValue" className="slider-value">32</span>
            <input type="range" id="xPaddingLabel" min="0" max="50" onInput={() => this.updateLegendItemPaddingX(event)} onChange={() => this.updateLegendItemPaddingX(event)} />
        </div>
    </div>
    <div className="toolPanel">
        <div className="slider">
            <label for="yPaddingLabel"><strong>item.paddingY:</strong></label>
            <span id="yPaddingValue" className="slider-value">8</span>
            <input type="range" id="yPaddingLabel" min="0" max="30" onInput={() => this.updateLegendItemPaddingY(event)} onChange={() => this.updateLegendItemPaddingY(event)} />
        </div>
    </div>
    <div className="toolPanel">
        <div className="slider">
            <label for="markerPaddingLabel"><strong>item.marker.padding:</strong></label>
            <span id="markerPaddingValue" className="slider-value">8</span>
            <input type="range" id="markerPaddingLabel" min="0" max="30" onInput={() => this.updateLegendItemSpacing(event)} onChange={() => this.updateLegendItemSpacing(event)} />
        </div>
    </div>
    <AgChartsReact
