...
@Component({
    ...
    <div class="toolPanel">
        ...
        <div class="button-group">
            Legend Position:
            <span class="spacer"></span>
            <button class="button--code" (click)="updateLegendPosition('right')">'right'</button>
            <span class="spacer"></span>
            <button class="button--code" (click)="updateLegendPosition('bottom')">'bottom'</button>
            <span class="spacer"></span>
            <button class="button--code" (click)="updateLegendPosition('left')">'left'</button>
            <span class="spacer"></span>
            <button class="button--code" (click)="updateLegendPosition('top')">'top'</button>
        </div>
    </div>
    <ag-charts-angular
    style="height: 100%"
