...
onBtExport = () => {
    ...
    <div className="columns">
        ...
        <div className="column margin-container">
            <div>Margins</div>
            <label for="top">Top = <input type="number" id="top" defaultValue="0.75" /></label>
            <label for="right">Right = <input type="number" id="right" defaultValue="0.7" /></label>
            <label for="bottom">Bottom = <input type="number" id="bottom" defaultValue="0.75" /></label>
            <label for="left">Left = <input type="number" id="left" defaultValue="0.7" /></label>
            <label for="header">Header = <input type="number" id="header" defaultValue="0.3" /></label>
            <label for="footer">Footer = <input type="number" id="footer" defaultValue="0.3" /></label>
        </div>
    </div>
    <div>
