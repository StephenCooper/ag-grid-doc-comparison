...
onFirstDataRendered = (params) => {
   ...
   openChartImage = (fileFormat) => {
    ...
    <div id="buttons">
        <button onClick={() => this.downloadChartImage('image/png')}>Download chart PNG</button>
        <button onClick={() => this.downloadChartImage('image/jpeg')}>Download chart JPEG</button>
        <button onClick={() => this.openChartImage('image/png')}>Open PNG</button>
        <button onClick={() => this.openChartImage('image/jpeg')}>Open JPEG</button>
    </div>
    <div
...
onChartCreated={this.onChartCreated.bind(this)}
    ...
    <div id="myChart" className="ag-theme-alpine my-chart">
</div></div>
            </div>
        );
    }
