...
import { ColDef, ColGroupDef, GetRowIdFunc, GetRowIdParams, Grid, GridOptions, IServerSideDatasource, IServerSideGetRowsParams, IServerSideGetRowsRequest, IsRowSelectable, RowNode, ServerSideStoreType } from 'ag-grid-community';
declare var _: any;
