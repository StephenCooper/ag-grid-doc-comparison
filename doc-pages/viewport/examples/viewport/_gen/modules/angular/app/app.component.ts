...
import { ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, Grid, GridApi, GridOptions, GridReadyEvent, ICellRendererComp, ICellRendererParams, IViewportDatasource, ValueFormatterParams } from '@ag-grid-community/core';
...
public rowData!: any[];
    ...
    onGridReady(params: GridReadyEvent) {
        ...
        this.http.get<any[]>('https://www.ag-grid.com/example-assets/stocks.json').subscribe(data => {
