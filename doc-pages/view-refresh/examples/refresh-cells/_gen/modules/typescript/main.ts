...
import { ColDef, ColGroupDef, Grid, GridApi, GridOptions, RefreshCellsParams, RowNode } from '@ag-grid-community/core';
...
// Attach external event handlers to window so they can be called from index.html
 ...
 (<any>window).scrambleAndRefreshTopToBottom = scrambleAndRefreshTopToBottom;
}