...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, RefreshCellsParams, RowNode } from '@ag-grid-community/core';
...
@Component({
    ...
    <div class="example-header">
        <div>
            <button (click)="scrambleAndRefreshAll()">Scramble &amp; Refresh All</button>
            <button (click)="scrambleAndRefreshLeftToRight()">Scramble &amp; Refresh Left to Right</button>
            <button (click)="scrambleAndRefreshTopToBottom()">Scramble &amp; Refresh Top to Bottom</button>
        </div>
        <div>
            <label>
