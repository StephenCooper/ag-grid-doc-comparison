   ...
   jumpToRow = () => {
    ...
    <div className="example-header">
        <div style={{"padding":"4px"}}>
            ...
            <button onClick={() => this.resetPinned()}>Left = #, Athlete, Age; Right = Total</button>
            <button onClick={() => this.pinCountry()}>Left = Country</button>
        </div>
    
        <div style={{"padding":"4px"}}>
            Jump to:
            <input placeholder="row" type="text" style={{"width":"40px"}} id="row" onInput={() => this.jumpToRow()} />
            <input placeholder="col" type="text" style={{"width":"40px"}} id="col" onInput={() => this.jumpToCol()} />
        </div>
    </div>
    <div
