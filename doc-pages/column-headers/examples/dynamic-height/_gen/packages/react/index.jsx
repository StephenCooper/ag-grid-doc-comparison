    ...
    <div className="button-bar example-header">
        <table>
            ...
            <tr>
                ...
                <td>
                    <button onClick={() => this.setGroupHeaderHeight(40)}>40px</button>
                    <button onClick={() => this.setGroupHeaderHeight(60)}>60px</button>
                    <button onClick={() => this.setGroupHeaderHeight()}>undefined</button>
                </td>
                <td>headerHeight (<span id="headerHeight">undefined</span>)</td>
                <td>
                    <button onClick={() => this.setHeaderHeight(70)}>70px</button>
                    <button onClick={() => this.setHeaderHeight(80)}>80px</button>
                    <button onClick={() => this.setHeaderHeight()}>undefined</button>
                </td>
            </tr>
            <tr id="requiresPivot" className="hidden">
                ...
                <td>
                    <button onClick={() => this.setPivotGroupHeaderHeight(50)}>50px</button>
                    <button onClick={() => this.setPivotGroupHeaderHeight(70)}>70px</button>
                    <button onClick={() => this.setPivotGroupHeaderHeight()}>undefined</button>
                </td>
                <td>pivotHeaderHeight (<span id="pivotHeaderHeight">undefined</span>)</td>
                <td>
                    <button onClick={() => this.setPivotHeaderHeight(60)}>60px</button>
                    <button onClick={() => this.setPivotHeaderHeight(80)}>80px</button>
                    <button onClick={() => this.setPivotHeaderHeight()}>undefined</button>
                </td>
            </tr>
            <tr id="requiresNotPivot">
                <td>floatingFiltersHeight (<span id="floatingFiltersHeight">undefined</span>)</td>
                <td>
                    <button onClick={() => this.setFloatingFiltersHeight(35)}>35px</button>
                    <button onClick={() => this.setFloatingFiltersHeight(55)}>55px</button>
                    <button onClick={() => this.setFloatingFiltersHeight()}>undefined</button>
                </td>
            </tr>
        </tbody></table>
    </div>
