...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, RowNode } from '@ag-grid-community/core';
...
@Component({
    ...
    <div style="margin-bottom: 1rem;">
        ...
        <button (click)="onBtForEachNodeAfterFilter()">For-Each Node After Filter</button>
        <button (click)="onBtForEachNodeAfterFilterAndSort()">For-Each Node After Filter and Sort</button>
...
onGridReady(params: GridReadyEvent) {
        ...
        this.http.get<any[]>('https://www.ag-grid.com/example-assets/olympic-winners.json').subscribe(data => params.api!.setRowData(data.slice(0, 50)));
    }
}
