...
onBtForEachNode = () => {
   ...
   onBtForEachLeafNode = () => {
    ...
    <div style={{"marginBottom":"1rem"}}>
        <button onClick={() => this.onBtForEachNode()}>For-Each Node</button>
        <button onClick={() => this.onBtForEachNodeAfterFilter()}>For-Each Node After Filter</button>
        <button onClick={() => this.onBtForEachNodeAfterFilterAndSort()}>For-Each Node After Filter and Sort</button>
        <button onClick={() => this.onBtForEachLeafNode()}>For-Each Leaf Node</button>
    </div>
