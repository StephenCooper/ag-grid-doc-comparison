    ...
    return (
      <div className="wrapper">
        <div className="toolPanel" style={{ paddingBottom: "15px" }}>
          <button onClick={() => this.applyTheme("ag-default")}>
            Default Theme
          </button>
          <button onClick={() => this.applyTheme("ag-default-dark")}>
            Default Dark Theme
          </button>
          <button onClick={() => this.applyTheme("ag-pastel-dark")}>
            Pastel Dark Theme
          </button>
          <button onClick={() => this.applyTheme("ag-vivid")}>
            Vivid Theme
          </button>
        </div>
