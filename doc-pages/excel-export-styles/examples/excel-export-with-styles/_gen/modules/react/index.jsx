...
onBtExport = () => {
    ...
    <div className="columns">
        <div className="option">
            ...
            <input type="text" id="fontSizeValue" defaultValue="14" style={{"width":"40px"}} />
        </div>
        <div className="option">
            <label for="rowHeight">
            ...
            <input type="text" id="rowHeightValue" defaultValue="30" style={{"width":"40px"}} />
        </div>
        <div className="option">
            ...
            <input type="text" id="headerRowHeightValue" defaultValue="30" style={{"width":"40px"}} />
        </div>
    </div>
    <div>
        <label>
