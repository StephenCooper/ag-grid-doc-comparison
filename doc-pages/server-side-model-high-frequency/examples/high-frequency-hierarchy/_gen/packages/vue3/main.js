...
const VueExample = {
    ...
    data: function() {
        return {
            columnDefs: [{field:"productName",
rowGroup:true,
hide:true},{field:"portfolioName",
rowGroup:true,
hide:true},{field:"bookId",
rowGroup:true,
hide:true},{headerName:"Current",
field:"current",
width:200,
type:"numericColumn",
...
filterParams:{"values":["Financial","Physical"]}},{headerName:"Bid",
field:"bidFlag",
width:100,
filter:"agSetColumnFilter",
filterParams:{"values":["Buy","Sell"]}},{headerName:"PL 1",
field:"pl1",
width:200,
type:"numericColumn",
valueFormatter:numberCellFormatter,
...
window.processUpdateFromFakeServer = function processUpdateFromFakeServer(gridApi, transactions) {
