...
import { AsyncTransactionsFlushed, ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, GetRowIdParams, Grid, GridApi, GridOptions, GridReadyEvent, IServerSideDatasource, IsApplyServerSideTransaction, IsApplyServerSideTransactionParams, ServerSideStoreType, ServerSideTransaction, ServerSideTransactionResult, ServerSideTransactionResultStatus, ValueFormatterParams } from 'ag-grid-community';
...
onGridReady(params: GridReadyEvent) {
    ...
    var dataSource: IServerSideDatasource = {
        getRows: function (params2) {
            fakeServer.getData(params2.request, params2.parentNode.data, function (result: any[], serverVersion: string) {
                params2.success({
                    rowData: result,
