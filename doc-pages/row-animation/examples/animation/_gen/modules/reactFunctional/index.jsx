...
ModuleRegistry.registerModules([ClientSideRowModelModule, RowGroupingModule, MenuModule, SetFilterModule, ColumnsToolPanelModule])
...
const GridExample = () => {
    ...
    <div className="example-header">
        <div style={{"display":"inline-block","height":"10px","marginTop":"5px","marginRight":"10px","width":"100px","border":"1px solid grey"}}>
            <div id="animationCountdown" className="transition-width" style={{"backgroundColor":"grey","height":"100%","width":"0%"}}></div>
        </div>
