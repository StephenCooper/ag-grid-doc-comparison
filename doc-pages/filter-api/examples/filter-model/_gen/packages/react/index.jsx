   ...
   destroyFilter = () => {
    ...
    <div>
        <div className="button-group">
            <button onClick={() => this.saveFilterModel()}>Save Filter Model</button>
            <button onClick={() => this.restoreFilterModel()}>Restore Saved Filter Model</button>
            <button onClick={() => this.restoreFromHardCoded()} title="Name = 'Mich%', Country = ['Ireland', 'United States'], Age < 30, Date < 01/01/2010">
