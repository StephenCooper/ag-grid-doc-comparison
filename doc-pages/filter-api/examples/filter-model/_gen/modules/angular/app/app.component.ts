...
@Component({
    ...
    <div>
        <div class="button-group">
            ...
            <button (click)="restoreFilterModel()">Restore Saved Filter Model</button>
            <button (click)="restoreFromHardCoded()" title="Name = 'Mich%', Country = ['Ireland', 'United States'], Age < 30, Date < 01/01/2010">
