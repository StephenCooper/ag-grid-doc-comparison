...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, ISetFilter } from '@ag-grid-community/core';
...
endingStan() {
    var countryFilterComponent = this.gridApi.getFilterInstance('country') as ISetFilter;
