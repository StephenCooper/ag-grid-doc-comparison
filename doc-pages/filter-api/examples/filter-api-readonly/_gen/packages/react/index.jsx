   ...
   clearSportFilter = () => {
    ...
    <div className="example-header">
        <span className="button-group">
            <button onClick={() => this.irelandAndUk()}>Ireland &amp; UK</button>
            <button onClick={() => this.endingStan()}>Countries Ending 'stan'</button>
            <button onClick={() => this.printCountryModel()}>Print Country</button>
            <button onClick={() => this.clearCountryFilter()}>Clear Country</button>
            <button onClick={() => this.destroyCountryFilter()}>Destroy Country</button>
        </span>
        <span className="button-group">
            <button onClick={() => this.ageBelow25()}>Age Below 25</button>
            <button onClick={() => this.ageAbove30()}>Age Above 30</button>
            <button onClick={() => this.ageBelow25OrAbove30()}>Age Below 25 or Above 30</button>
            <button onClick={() => this.ageBetween25And30()}>Age Between 25 and 30</button>
            <button onClick={() => this.clearAgeFilter()}>Clear Age Filter</button>
        </span>
        <span className="button-group">
            <button onClick={() => this.after2010()}>Date after 01/01/2010</button>
            <button onClick={() => this.before2012()}>Date before 01/01/2012</button>
            <button onClick={() => this.dateCombined()}>Date combined</button>
            <button onClick={() => this.clearDateFilter()}>Clear Date Filter</button>
        </span>
        <span className="button-group">
            <button onClick={() => this.sportStartsWithS()}>Sport starts with S</button>
            <button onClick={() => this.sportEndsWithG()}>Sport ends with G</button>
            <button onClick={() => this.sportsCombined()}>Sport starts with S and ends with G</button>
            <button onClick={() => this.clearSportFilter()}>Clear Sport Filter</button>
        </span>
    </div>
    <div
