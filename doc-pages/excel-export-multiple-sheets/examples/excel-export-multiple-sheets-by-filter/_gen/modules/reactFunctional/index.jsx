...
ModuleRegistry.registerModules([ClientSideRowModelModule, MenuModule, ExcelExportModule, SetFilterModule])
...
const onBtExport = useCallback(() => {
    ...
    var spreadsheets = [];
    var sportFilterInstance = gridRef.current.api.getFilterInstance('sport');
