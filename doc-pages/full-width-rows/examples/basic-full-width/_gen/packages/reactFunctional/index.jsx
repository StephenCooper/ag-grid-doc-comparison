...
const GridExample = () => {
    ...
    const pinnedTopRowData = useMemo(() => { return createData(3, 'pinned') }, []);
    const pinnedBottomRowData = useMemo(() => { return createData(3, 'pinned') }, []);
    ...
    const fullWidthCellRenderer = useMemo(() => { return FullWidthCellRenderer }, []);
