...
import { ColDef, ColGroupDef, FirstDataRenderedEvent, Grid, GridOptions, IDoesFilterPassParams, IFilterComp, IFilterParams, IServerSideDatasource, ServerSideStoreType, SideBarDef } from '@ag-grid-community/core';
...
ModuleRegistry.registerModules([ServerSideRowModelModule, RowGroupingModule, MenuModule, ColumnsToolPanelModule, FiltersToolPanelModule, SetFilterModule])
