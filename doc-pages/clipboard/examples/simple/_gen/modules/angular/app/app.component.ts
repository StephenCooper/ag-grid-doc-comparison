...
import { CellValueChangedEvent, ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, PasteEndEvent, PasteStartEvent } from '@ag-grid-community/core';
...
@Component({
    ...
    <button (click)="onBtCopyRange()">Copy Selected Range to Clipboard</button>
    &nbsp;&nbsp;&nbsp;&nbsp;
