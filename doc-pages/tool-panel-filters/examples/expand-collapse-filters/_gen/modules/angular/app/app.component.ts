...
public rowData!: any[];
    ...
    collapseAll() {
    (this.gridApi.getToolPanelInstance('filters') as any as IFiltersToolPanel).collapseFilters();
}
...
collapseYear() {
    (this.gridApi.getToolPanelInstance('filters') as any as IFiltersToolPanel).collapseFilters(['year']);
}
