...
@Component({
    ...
    <div>
        <span class="button-group">
            <button (click)="expandAthleteAndCompetition()">Expand Athlete &amp; Competition</button>
...
public rowData!: any[];
    ...
    collapseAll() {
    (this.gridApi.getToolPanelInstance('filters') as any as IFiltersToolPanel).collapseFilterGroups();
}
...
expandAll() {
    (this.gridApi.getToolPanelInstance('filters') as any as IFiltersToolPanel).expandFilterGroups();
}
