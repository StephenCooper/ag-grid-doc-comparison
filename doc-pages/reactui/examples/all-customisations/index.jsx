...
function GridExample() {
  ...
  const statusBar = useMemo(
    () => ({
      statusPanels: [{ key: "myStatusPanel", statusPanel: MyStatusPanel }],
    }),
    []
  );
  ...
  const onCallFilter = useCallback(() => {
    ...
    gridRef.current.api.getFilterInstance("year", (filterRef) =>
      filterRef.sampleToggleMethod()
    );
  });
  ...
  const onCallToolPanel = useCallback(() => {
    ...
    const toolPanelRef =
      gridRef.current.api.getToolPanelInstance("myToolPanel");
