...
refreshCache = (route) => {
    ...
    <div style={{"marginBottom":"5px"}}>
        <button onClick={() => this.refreshCache([])}>Refresh Everything</button>
        <button onClick={() => this.refreshCache(['Kathryn Powers','Mabel Ward'])}>Refresh ['Kathryn Powers','Mabel Ward']</button>
    </div>
    <div
