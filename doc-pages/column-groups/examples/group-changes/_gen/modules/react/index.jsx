   ...
   onParticipantAndMedalsInGroups = () => {
    ...
    <div className="test-header">
        ...
        <label>
            ...
            <button onClick={() => this.onParticipantInGroupOnly()}>Participant in Group</button>
        </label>
        <label>
            <div className="medals-group legend-box"></div>
            <button onClick={() => this.onMedalsInGroupOnly()}>Medals in Group</button>
        </label>
        <label>
            <div className="participant-group legend-box"></div>
            <div className="medals-group legend-box"></div>
            <button onClick={() => this.onParticipantAndMedalsInGroups()}>Participant and Medals in Group</button>
        </label>
    </div>
    <div
