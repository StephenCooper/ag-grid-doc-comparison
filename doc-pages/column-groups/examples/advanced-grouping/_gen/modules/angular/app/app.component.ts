...
import { ColDef, ColGroupDef, ColumnApi, Grid, GridApi, GridOptions, GridReadyEvent, HeaderClassParams } from '@ag-grid-community/core';
...
public defaultColGroupDef: Partial<ColGroupDef> = { headerClass: headerClassFunc };
