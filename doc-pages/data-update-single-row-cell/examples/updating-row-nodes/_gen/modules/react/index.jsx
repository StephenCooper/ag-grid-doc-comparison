...
updateSort = () => {
   ...
   setDataOnFord = () => {
    ...
    <div style={{"marginBottom":"1rem"}}>
        <button onClick={() => this.setPriceOnToyota()}>Set Price on Toyota</button>
        <button onClick={() => this.setDataOnFord()}>Set Data on Ford</button>
        <button onClick={() => this.updateSort()} style={{"marginLeft":"15px"}}>Sort</button>
