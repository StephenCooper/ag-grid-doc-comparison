...
import { ColDef, ColGroupDef, ColumnApi, GetRowIdFunc, Grid, GridApi, GridOptions, GridReadyEvent, IServerSideDatasource, ServerSideStoreType } from '@ag-grid-community/core';
...
@Component({
    ...
    <div style="margin-bottom: 5px;">
        ...
        <button (click)="refreshCache(['Canada',2002])">Refresh [Canada,2002]</button>
