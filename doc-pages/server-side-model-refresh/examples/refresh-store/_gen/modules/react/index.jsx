...
refreshCache = (route) => {
   ...
   getBlockState = () => {
    ...
    <div style={{"marginBottom":"5px"}}>
        <button onClick={() => this.refreshCache([])}>Refresh Top Level</button>
        <button onClick={() => this.refreshCache(['Canada'])}>Refresh [Canada]</button>
        <button onClick={() => this.refreshCache(['Canada',2002])}>Refresh [Canada,2002]</button>
        <button onClick={() => this.getBlockState()}>Print Block State</button>
